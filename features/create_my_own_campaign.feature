Feature: Create my own campaign
  ...
  Scenario: when I'm smart enough to successfully fill the new campaign form
    ...
    And I fill "Código de Embed do Google Maps" with "<iframe src='http://www.google.com/maps?ie=UTF8&amp;ll=37.0625,-95.677068&amp;spn=40.732051,78.662109&amp;t=m&amp;z=4&amp;output=embed'><\/iframe>"
    And I fill "Descreva o mapa!" with "Descrição do Mapa"
